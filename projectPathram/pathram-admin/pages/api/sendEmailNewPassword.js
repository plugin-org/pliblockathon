 ...
 */
 ...
 export default async function sendEMail(req, res) {
   try {
     ...
     const SUBJECT = "Password Update Suscessful";

 
     // const random = makeid(30);
 
     const link = `https://dasthavej-main.vercel.app/login`;
 ...
 <div id="email">
   ...
   <table role="presentation" border="0" cellpadding="0" cellspacing="10px" style="padding: 30px 30px 30px 60px;">
      <tr>
        <td>
         <h3 style="font-family: Josefin Sans;">Password Update Sucessful</h3>
         <h2 style="font-family: Josefin Sans;"></h2>
          <p>
 Your Password has been sucessfully updated. Login using below link.
             </p>
             <a href="${link}"><button>Login Here</button></a>
       ...
       <tr>
           <td align="center" style="padding: 30px 30px;">
             ...
             <p style="font-style: italic;" >
                 Note: Thank you for using Dasthavej.
               </p>
