...
export default async function sendEMail(req, res) {
  try {
    ...
    const link = `https://dasthavej-main.vercel.app/key/${random}&${uid}`;
...
<div id="email">
  ...
  <table role="presentation" border="0" cellpadding="0" cellspacing="10px" style="padding: 30px 30px 30px 60px;">
     <tr>
       <td>
        <h3 style="font-family: Josefin Sans;">Hello</h3>
        <h2 style="font-family: Josefin Sans;">${name}</h2>
        
            <p>
                Welcome to Dasthavej.
            </p> <p>
Please find your login credentials from the below link.
            </p>
  ...
  <table role="presentation" bgcolor="#F1F0FF" width="100%" style="margin-top: 50px;" >
      <tr>
          <td align="center" style="padding: 30px 30px;">
            ...
            <p style="font-style: italic;" >
                Note: The link can be viewed only once. So please make sure you have proper internet connection before accessing the same.
              </p>
      ...
      attachments: [
        {
          filename: "logo.png",
          href: "https://i.ibb.co/2gPZF4C/Component-2.png",
