...
export default async function sendEmailOnContactRequested(req, res) {
  try {
...
<div id="email">
  ...
  <table role="presentation" border="0" cellpadding="0" cellspacing="10px" style="padding: 30px 30px 30px 60px;">
     <tr>
       <td>
        <h3 style="font-family: Josefin Sans;">Request Raised for Information by ${name}</h3>
        
            <p>
                ${message}
            </p> 
            <a href="${link}"><button>Click Here To Reply</button></a>
