...
export default async function sendEMailtoSignersofNewEvent(req, res) {
  try {
    ...
    const link = `https://dasthavej-main.vercel.app/signer/authorize`;
...
<div id="email">
  ...
  <table role="presentation" border="0" cellpadding="0" cellspacing="10px" style="padding: 30px 30px 30px 60px;">
     <tr>
       <td>
        <h3 style="font-family: Josefin Sans;">New Event Created</h3>
        <h2 style="font-family: Josefin Sans;">${eventId}</h2>
        
            <p>
                New Event is created for you to Sign.
            </p> <p>
The Event is raised by ${raisedBy}. You can authorize the Dasthavej from the link below.
            </p>
            <a href="${link}"><button>Authorize</button></a>
