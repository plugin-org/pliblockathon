...
export default async function sendEmailForgotPassword(req, res) {
  try {
    ...
    const link = `https://dasthavej-main.vercel.app/usersResetPassword/${email}`;
...
<div id="email">
  ...
  <table role="presentation" border="0" cellpadding="0" cellspacing="10px" style="padding: 30px 30px 30px 60px;">
     <tr>
       <td>
        <h3 style="font-family: Josefin Sans;">Password Reset Requested</h3>
        <h2 style="font-family: Josefin Sans;">${email}</h2>
        <p>
Please reset the credentials from the link below.
            </p>
            <a href="${link}"><button>Reset Here</button></a>
