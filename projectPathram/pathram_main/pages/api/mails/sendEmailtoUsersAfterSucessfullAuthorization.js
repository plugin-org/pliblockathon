...
export default async function sendEmailtoUsersAfterSucessfullAuthorization(
  req,
  res
) {
  try {
    const TO = req.body.TO;
    const SUBJECT = "Your Event Authorized Succesfully";
...
<div id="email">
  ...
  <table role="presentation" border="0" cellpadding="0" cellspacing="10px" style="padding: 30px 30px 30px 60px;">
     <tr>
       <td>
        <h3 style="font-family: Josefin Sans;">Event Approved</h3>
        <h2 style="font-family: Josefin Sans;">${eventId}</h2>
        
            <p>
                Hello ${raisedBy}
            </p> <p>
      Your event ${eventId} is approved.
            </p>
