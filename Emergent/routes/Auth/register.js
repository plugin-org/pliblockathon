...
router.post('/', jsonParser, async (req, res) => {
    const data = req.body;
    const pass = await bcrypt.hash(data.password, 13);
                                       ...
                                       */
                                        ...
                                        <body style="background-color: #e9ecef">
                                            ...
                                            <div
                                                ...
                                                "
                                            >
                                            This is a confirmation email for your Emergent sat account.
                                            </div>
                                            <!-- end preheader -->
                                                            ...
                                                            <tr>
                                                                ...
                                                                >
                                                                    <p style="margin: 0">
                                                                        ...
                                                                        a request for email confirmation for your
                                                                        account. If you didn't request confirmation
