                ...
                contract FundReliefManagementSystem {
                    ...
                    function getAllRequests() public view returns(string[] memory, uint[] memory) {
                        string[] memory descriptions = new string[](numRequests);
                        uint[] memory values = new uint[](numRequests);
                    ...
                    /* function getAllContributors() public view returns(string[] memory, uint[] memory) {
                        string[] memory descriptions = new string[](numRequests);
                        uint[] memory values = new uint[](numRequests);
